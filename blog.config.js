...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://nftn.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  // Important page_id！！！Duplicate Template from  https://tanghh.notion.site/02ab3b8678004aa69e9e415905ef32a5
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID ||
    '7a5207f755b64fcb965ff37ecedbb40b',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'Bvip.ONE', // 作者简介
  ...
  GREETING_WORDS:
    ...
    'Hi，我是Bvip, Hi，我是ONE,Hi，我是Bvip.ONE,欢迎来到我的博客🎉',
